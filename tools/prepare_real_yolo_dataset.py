...
def main():
    ...
    ap.add_argument('--images', default='datasets/dji_action4_real_det_to_label/images')
    ap.add_argument('--labels-zip', default='datasets/yolo.zip')
    ap.add_argument('--out', default='datasets/dji_action4_real_det')
    ...
    yaml = out / 'dji_action4_real.yaml'
    yaml.write_text(
        f'path: {out.resolve()}\n'
        'train: images/train\n'
        'val: images/val\n'
